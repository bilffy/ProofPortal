...
/****************************************************************************************** Tags Input - Groups *****************************************************************************************************************/
    ...
    $('#GridSpellingEdits_Modal').on('show.bs.modal', function (event) {
        ...
        var subjectName = button.attr('data-subject-name'); // Extract info from attributes

        var filterBox = $('input#subject-name-filter');

        if (typeof subjectName !== 'undefined') {
            filterBox.val(subjectName).parent().parent();
        } else {
            filterBox.val('').parent().parent();
        }

        filterBox.trigger('click');
    })

    $("input[id*='-grid-spelling-']").on("change", function (event) {
    ...
    $("span[id*='-grid-spelling-revert-button']").on("click", function (event) {
    ...
    /****************************************************************************************** Proofing - Final submit *****************************************************************************************************************/
        ...
        $('.modal_start').on('change', '.is_subject_select', function() {
            ...
            if (template) {
                ...
                var salutation = $('#'+skHash+'-salutation').first().text();
                ...
                var homefolders = templateElement.find('select[name="' + skHash + '_folder_issue"]')
