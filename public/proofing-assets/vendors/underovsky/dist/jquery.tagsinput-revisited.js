...
!function (a) {
    ...
    a.fn.addTag = function (g, h) {
        return h = jQuery.extend({focus: !1, callback: !0}, h), this.each(function () {
            ...
            "" === j[0] && (j = []), g = jQuery.trim(g);
            var k = c[i];
            if (k.whitelist && k.whitelist.indexOf(g) === -1) return !1;
            if (c[i].unique && a(this).tagExist(g) || !f(g, c[i], j, b[i])) return a("#" + i + "_tag").addClass("error"), !1;
            if (a("<span>", {class: "tag"}).append(a("<span>", {class: "tag-text"}).text(g), a("<button>", {class: "tag-remove"}).click(function () {
        ...
        return this.each(function () {
            if ("undefined" == typeof a(this).data("tagsinput-init")) {
                ...
                var l = a("<div>", {
                    id: f + "_tagsinput",
                    class: "tagsinput"
                }).append(a("<div>", {id: f + "_addTag"}).append(i.interactive ? a("<input>", {
                    id: f + "_tag",
                    class: "tag-input",
                    value: "",
                    placeholder: i.placeholder
                }) : null));
                a(l).insertAfter(this), a(k.holder).css("width", i.width), a(k.holder).css("min-height", i.height), a(k.holder).css("height", i.height), "" !== a(k.real_input).val() && a.fn.tagsInput.importTags(a(k.real_input), a(k.real_input).val()), i.interactive && (a(k.fake_input).val(""), a(k.fake_input).data("pasted", !1), a(k.fake_input).on("focus", k, function (b) {
                    ...
                    jQuery.inArray(b.keyCode, [13, 37, 38, 39, 40, 27, 16, 17, 18, 225]) === -1 && a(this).removeClass("error")
                }))
            }
        }), this
    ...
    var e = function (a) {
        return "undefined" == typeof a ? a : "string" == typeof a ? a : a[0]
    }, f = function (b, c, d, e) {
        var f = !0;
