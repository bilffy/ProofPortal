...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('folder_tags', function (Blueprint $table) {
            $table->id();
            $table->string('tag', 100)->charset('utf8mb4')->collation('utf8mb4_general_ci')->nullable();
            $table->string('external_name', 100)->charset('utf8mb4')->collation('utf8mb4_general_ci')->nullable();
            $table->timestamps();
        });
