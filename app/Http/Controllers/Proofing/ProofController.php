...
class ProofController extends Controller
{
    ...
    {
        $selectedFolders = $this->folderService->getFolderByJobId($tsJobId)->with('images')->orderBy('ts_foldername', 'asc')->get();
    ...
    public function MyFoldersValidate($folderKey = null)
    {
        ...
        return view('proofing.franchise.proof-my-people.validate-people', [
            ...
            'allSubjects' => $currentFolder->subjects,
            ...
            'allSubjectsByJob' => $currentFolder->job->subjects,
            'user' => new UserResource(Auth::user()),
        ]);
    }
