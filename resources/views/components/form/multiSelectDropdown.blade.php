<div x-data="dropdownComponent()" class="w-[100px] relative">
    <x-button.link @click="open = !open">
        <x-icon icon="filter fa-sm" class="text-[#CFD1DE]"/>
    </x-button.link>

    <div x-show="open" @click.away="open = false" class="absolute z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
