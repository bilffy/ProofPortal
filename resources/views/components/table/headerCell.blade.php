...
<th scope="col" {{ $attributes->merge([ 'class' => "TableHeaderCell border-b-2  border-neutral-300 p-4" ]) }} x-cloak>
    @php
    ...
    >
        @if ($isFilterable)
            ...
            <div id="filterDropdown-{{ $filterModel }}" class="relative">
                <div x-show="open" @click.away="open = false" class="absolute z-10 top-9 start-10 bg-white divide-y divide-gray-100 rounded-lg shadow" x-cloak>
