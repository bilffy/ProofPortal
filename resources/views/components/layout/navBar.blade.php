...
<div class="flex flex-col mt-2 mr-2">
    ...
    @can ($PermissionHelper->getAccessToPage($PermissionHelper::SUB_PHOTOGRAPHY))
        <span class="hideOnCollapse whitespace-nowrap text-sm text-neutral-600 ml-4 font-bold mt-4">PHOTOGRAPHY</span>
    ...
    @can ($PermissionHelper->getAccessToPage($PermissionHelper::SUB_PROOFING))
        <span class="hideOnCollapse whitespace-nowrap text-sm text-neutral-600 ml-4 font-bold mt-4">PROOFING</span>
    ...
    @can ($PermissionHelper->getAccessToPage($PermissionHelper::SUB_ORDERING))
        <span class="hideOnCollapse whitespace-nowrap text-sm text-neutral-600 ml-4 font-bold mt-4">ORDERING</span>
    ...
    @can ($PermissionHelper->getAccessToPage($PermissionHelper::SUB_ADMIN_TOOLS))
        <span class="hideOnCollapse whitespace-nowrap text-sm text-neutral-600 ml-4 font-bold mt-4">ADMIN TOOLS</span>
    ...
    @endcan
    <span class="hideOnCollapse whitespace-nowrap text-sm ml-4 font-bold mt-4 text-alert">TESTING PAGE</span>
