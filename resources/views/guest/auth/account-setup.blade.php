    ...
    <form wire:submit.prevent="submit"
        ...
        <div class="flex flex-col items-center mb-4">
            <label class="inline-flex">
                ...
                <span class="text-xs text-gray-500">I have read the <a href="https://www.msp.com.au/msp-terms-conditions/" target="_blank" class="text-blue-600 underline">Terms of Use & Copyright Conditions</a>, and understand it applies to all digital images uploaded by MSP on this Portal site.</a></span>
            </label>
