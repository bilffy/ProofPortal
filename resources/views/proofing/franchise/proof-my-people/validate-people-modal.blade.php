...
@endphp
    ...
    @if ($currentFolder->is_edit_portraits)
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-3 col-sm-12">
                                        <img style="width: 100%" class="lazyload mx-auto d-block" data-src="{{ $image_url }}" alt="Photo-Image">
                                    </div>
        ...
        <div class="modal fade" id="GridSpellingEdits_Modal" tabindex="-1" role="dialog" aria-labelledby="GridSpellingEdits_ModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <input class="form-control" id="subject-name-filter" type="text" name="subject-name-filter"
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tr>
                                ...
                                @if ($currentFolder->is_edit_salutation)
                                    <th class="idx-salutation" scope="col">
                                        Salutation
                                    </th>
                                @endif
                                <th class="idx-first-name" scope="col">
                                    First Name
                                </th>
                                <th class="idx-last-name" scope="col">
                                    Last Name
                                </th>
                                @if ($currentFolder->is_edit_job_title)
                                    <th class="idx-job-title" scope="col">
                                        Job Title
                                    </th>
                                @endif
                                <th class="idx-last-name" scope="col">
                                ...
                                <tr class="person-row {{ $skHash }}"
                                    ...
                                    <td class="idx-artifact text-center pt-2 pb-1">
                                        <div class="person-pic-wrapper d-inline">
                                            {{-- <img src="{{ $image_url }}" alt="Subject Image" style="max-height: 100px;width:100%;"> --}}
                                            <img style="width: 100%" class="lazyload mx-auto d-block" data-src="{{ $image_url }}" alt="Subject Image">
                                        </div>
                                    </td>
                                    @if ($currentFolder->is_edit_salutation)
