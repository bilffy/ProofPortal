                            ...
                            <tr>
                                <th width="30%" style="padding: 20px 40px 20px 40px;" class="stack">
                                    <p style="font-family: 'Montserrat', Helvetica, Arial, sans-serif !important; font-size: 14px; font-weight: 700; color: #666666; line-height: 1.4; text-align: left;">
                                        ...
                                        {FRANCHISE_NAME}
                                        <br/>
                                        <a href="mailto:{FRANCHISE_EMAIL}" style="text-decoration: none; color: #666666; font-weight: 700;">
                                            {FRANCHISE_EMAIL}
                                        </a>
                                        <br/>
                                        <a href="https://{FRANCHISE_WEB_ADDRESS}" style="text-decoration: none; color: #666666; font-weight: 700;">
                            ...
                            <tr>
                                <td colspan="2" bgcolor="#00b3e0" style="padding: 20px 40px 20px 40px; text-align: center;">
                                    ...
                                    <a href="mailto:{FRANCHISE_EMAIL}">
                                        <img src="https://www.msp.com.au/wp-content/uploads/2020/02/msp_op_button_email.png" width="225" alt="Contact Us" style="display: block; margin: 0 auto; border: 0;">
                                    </a>
                                </td>
                            </tr>
                        </table>
