                ...
                <div class="flex flex-row items-center">
                    ...
                    <div class="ms-3 relative">
                        <Dropdown width="48">
                            ...
                            <template #content>
                                <!-- <DropdownLink :href="getRoute('profile.edit')"> Profile </DropdownLink> -->
                                <DropdownLink :href="getRoute('logout')" method="post" as="button">
                                    Log Out
                                </DropdownLink>
                            </template>
                        </Dropdown>
...
import { getRoute } from '@/helpers/utils.helper';
